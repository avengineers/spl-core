...
This tutorial shall give you a quick start with CMake and SPL Core.

.. attention::

    This tutorial was written to be used on a Windows machine and all given command line calls shall be executed in a PowerShell terminal.
    Nevertheless SPL Core is usable on other OS instances as well.
