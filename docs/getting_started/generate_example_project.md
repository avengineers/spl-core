...
```{note}
For more information about `scoop` and how to import dependencies from a `scoopfile.json` file, please refer to the [scoop documentation](https://github.com/ScoopInstaller/Scoop).
```
